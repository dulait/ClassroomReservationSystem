...
public class AuthController {
    ...
    public ResponseEntity<String> verifyTempPassword(@RequestParam("email") String email, @RequestParam("password") String tempPassword) {
        Response<String> response = authService.verifyTempPassword(email, tempPassword);
        return converter.toResponseEntity(response);
    }

    @PostMapping("/set-new-password")
    public ResponseEntity<String> setNewPassword(@RequestParam("email") String email, @RequestParam("password") String newPassword) {
        Response<String> response = authService.setNewPassword(email, newPassword);
        return converter.toResponseEntity(response);
    }
